...
public class BlockedCachingTool : IBlockedCachingTool
{
    private readonly IEasyCachingProvider _cachingProvider;

    public BlockedCachingTool(IEasyCachingProviderFactory cachingFactory)
    {
        _cachingProvider = cachingFactory.GetCachingProvider("blocked");
    }
