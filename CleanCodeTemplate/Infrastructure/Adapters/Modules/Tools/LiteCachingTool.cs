...
public class LiteCachingTool : ILiteCachingTool
{
    
    private readonly IEasyCachingProvider _cachingProvider;

    public LiteCachingTool(IEasyCachingProviderFactory cachingFactory)
    {
        _cachingProvider = cachingFactory.GetCachingProvider("lite");
    }
